...
Experience
The learner scans for a surface and places the training machine onto a detected AR plane.
The lesson highlights machine hazards for inspection, including electrical energy, pressure systems, and moving components.
The learner completes the lockout/tagout sequence in the correct order:
Power off
Release pressure
Apply lock
Verify safe state
The machine transitions into safe maintenance mode.
